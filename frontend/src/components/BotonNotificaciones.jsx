...
function BotonNotificaciones() {
  ...
  return (
    <>
      ...
      {abierto && (
        <div
          className="fixed inset-0 bg-tinta/40 backdrop-blur-sm z-50 flex items-center justify-center p-4"
            ...
            <div className="bg-white border border-borde rounded-2xl p-6">
              <div className="flex justify-between items-start gap-4 mb-2">
                ...
                <button
                  ...
                  onClick={() => setAbierto(false)}
                  aria-label="Cerrar"
                  className="text-tinta-suave hover:text-tinta transition shrink-0"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>

              <p className="text-sm text-tinta-media mb-6">
